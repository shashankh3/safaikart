...
export const YStack = ({ children, style: customStyle, onLayout, ...props }) => {
...
export const XStack = ({ children, style: customStyle, onLayout, ...props }) => {
  const { style, rest } = mapPropsToStyle(props);
  return (
...
export const ZStack = ({ children, style: customStyle, onLayout, ...props }) => {
  const { style, rest } = mapPropsToStyle(props);
  return (
