...
exports.createPaymentOrder = (0, https_1.onCall)({ secrets: [razorpayClient_1.razorpayKeyId, razorpayClient_1.razorpayKeySecret], enforceAppCheck: config_1.shouldEnforceAppCheck }, async (request) => {
    var _a, _b;
