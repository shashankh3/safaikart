...
exports.buildOrderNotification = buildOrderNotification;
function buildOrderNotification(before, after, orderId) {
    var _a;
        ...
        switch (after.status) {
            case 'CONFIRMED':
                return {
                    ...
                    body: `Order #SK-${shortId} confirmed! Pickup: ${((_a = after.pickupSlotSnapshot) === null || _a === void 0 ? void 0 : _a.date) || 'soon'}.`,
                    type: 'order_update'
                };
...
//# sourceMappingURL=notificationLogic.js.map